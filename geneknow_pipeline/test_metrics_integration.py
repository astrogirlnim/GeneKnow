...
def test_metrics_calculation_logic():
    ...
    # Create sample data
    risk_scores = {"breast": 65.0, "colon": 25.0, "lung": 15.0}

    risk_details = {
        "breast": {"model_confidence": 0.85, "gene_count": 3, "pathogenic_count": 2},
        "colon": {"model_confidence": 0.75, "gene_count": 1, "pathogenic_count": 0},
        "lung": {"model_confidence": 0.80, "gene_count": 0, "pathogenic_count": 0},
    }
    ...
    ml_assessment = {
        ...
        "contributing_factors": {"cadd_score": 0.8, "clinvar_classification": 0.9},
    }
