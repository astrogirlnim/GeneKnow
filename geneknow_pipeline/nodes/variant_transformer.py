...
def simulate_codon_context(variant: Dict) -> tuple:
    ...
    cancer_gene_codons = {
        "TP53": {"re": "CGT", "alt": "CAT"},  # R273H - common TP53 mutation
        "KRAS": {"re": "GGT", "alt": "GAT"},  # G12D - common KRAS mutation
        "BRAF": {"re": "GTG", "alt": "GAG"},  # V600E - common BRAF mutation
        "EGFR": {"re": "CTG", "alt": "CGG"},  # L858R - common EGFR mutation
        "PIK3CA": {"re": "CAT", "alt": "AAT"},  # H1047N - common PIK3CA mutation
        # Blood cancer genes
        "AK9": {"re": "GCT", "alt": "ACT"},  # Ala→Thr - common AK9 mutation
        "JAK2": {"re": "GTG", "alt": "TTG"},  # V617F - common JAK2 mutation
        "FLT3": {"re": "GAT", "alt": "TAT"},  # D835Y - common FLT3 mutation
        "NPM1": {"re": "TGG", "alt": "TAG"},  # W288* - common NPM1 mutation
        "DNMT3A": {"re": "CGT", "alt": "CAT"},  # R882H - common DNMT3A mutation
        "IDH1": {"re": "CGT", "alt": "CAT"},  # R132H - common IDH1 mutation
        "IDH2": {"re": "CGT", "alt": "CAT"},  # R140Q - common IDH2 mutation
        "RUNX1": {"re": "GAT", "alt": "AAT"},  # D171N - common RUNX1 mutation
        "TET2": {"re": "CAT", "alt": "TAT"},  # H1881Y - common TET2 mutation
        "ASXL1": {"re": "GAT", "alt": "AAT"},  # G646W - common ASXL1 mutation
        "CEBPA": {"re": "CTG", "alt": "CCG"},  # L312P - common CEBPA mutation
        "KIT": {"re": "GAT", "alt": "AAT"},  # D816V - common KIT mutation
        "NRAS": {"re": "GGT", "alt": "GAT"},  # G12D - common NRAS mutation
        "CBL": {"re": "CAT", "alt": "TAT"},  # H94Y - common CBL mutation
        "EZH2": {"re": "TAT", "alt": "CAT"},  # Y641H - common EZH2 mutation
        "STAT5B": {"re": "AAT", "alt": "GAT"},  # N642H - common STAT5B mutation
        # Breast cancer genes
        "BRCA1": {"re": "GAT", "alt": "AAT"},  # C61G - common BRCA1 mutation
        "BRCA2": {"re": "GAT", "alt": "TAT"},  # D2723H - common BRCA2 mutation
        "PALB2": {"re": "GAT", "alt": "AAT"},  # L939W - common PALB2 mutation
        "ATM": {"re": "GAT", "alt": "AAT"},  # D1853N - common ATM mutation
        "CHEK2": {"re": "GAT", "alt": "AAT"},  # I157T - common CHEK2 mutation
        # Colon cancer genes
        "APC": {"re": "GAT", "alt": "TAT"},  # R1450* - common APC mutation
        "SMAD4": {"re": "GAT", "alt": "AAT"},  # R361H - common SMAD4 mutation
        "MLH1": {"re": "GAT", "alt": "AAT"},  # V213M - common MLH1 mutation
        "MSH2": {"re": "GAT", "alt": "AAT"},  # A636P - common MSH2 mutation
        "MSH6": {"re": "GAT", "alt": "AAT"},  # F1088L - common MSH6 mutation
        # Lung cancer genes
        "ALK": {"re": "GAT", "alt": "AAT"},  # F1174L - common ALK mutation
        "ROS1": {"re": "GAT", "alt": "AAT"},  # G2032R - common ROS1 mutation
        "MET": {"re": "GAT", "alt": "AAT"},  # N375S - common MET mutation
        # Prostate cancer genes
        "AR": {"re": "GAT", "alt": "AAT"},  # T877A - common AR mutation
        "PTEN": {"re": "GAT", "alt": "AAT"},  # R130Q - common PTEN mutation
        # Bone cancer genes
        "RB1": {"re": "GAT", "alt": "TAT"},  # R661W - common RB1 mutation
        "EWSR1": {"re": "GAT", "alt": "AAT"},  # Fusion breakpoint
        "FLI1": {"re": "GAT", "alt": "AAT"},  # Fusion partner
        "CDKN2A": {"re": "GAT", "alt": "TAT"},  # A148T - common CDKN2A mutation
        "MDM2": {"re": "GAT", "alt": "AAT"},  # SNP309 - common MDM2 variant
    }

    # Handle known cancer genes with predefined codons (for both SNVs and complex variants)
    if gene in cancer_gene_codons:
        return cancer_gene_codons[gene]["re"], cancer_gene_codons[gene]["alt"]
    ...
    if ref_codon in ["DEL", "INS", "COMPLEX"]:
        ...
        if ref_codon == "DEL":
            ...
            return {
                "original": f"{len(ref)}bp",
                "mutated": f"{len(alt)}bp",
                "amino_acid_change": "Complex substitution",
