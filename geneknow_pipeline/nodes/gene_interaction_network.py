...
def analyze_network_properties(interactions: List[Dict], genes: List[str]) -> Dict:
    ...
    hub_genes = [gene for gene, count in gene_connections.items() 
...
def process(state: Dict) -> Dict:
    ...
    try:
        ...
        if len(affected_genes) > 50:
            ...
            logger.info(f"Limited analysis to top 50 genes by variant count")
