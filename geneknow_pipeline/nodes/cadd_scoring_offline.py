"""
Offline CADD scoring node.
Computes CADD-like deleteriousness scores locally without external dependencies.
Suitable for desktop applications that must work completely offline.
"""
import logging
