...
class SHAPValidator:
    ...
    def _get_top_contributors(
        self, shap_values: np.ndarray, feature_names: List[str], n_top: int = 3
    ) -> List[Dict[str, Any]]:
        """
        ...
        if not has_pathogenic_contributor:
            ...
            if has_pathogenic_variant:
                reasons.append(
                    ...
                    "rather than known disease-causing mutations. The prediction may be less reliable."
                )
            else:
            ...
            if pathogenic_idx is not None:
                ...
                if pathogenic_shap < MIN_PATHOGENIC_CONTRIBUTION:
                    ...
                    reasons.append(
                        ...
                        "The risk score may be incorrectly low."
                    )
