...
CANCER_GENES = {
    "BRCA1", "BRCA2", "TP53", "KRAS", "APC", "EGFR", "PIK3CA", "PTEN", "ATM",
    "CHEK2", "PALB2", "NBN", "NF1", "RB1", "VHL", "MLH1", "MSH2", "MSH6",
    "PMS2", "EPCAM", "CDKN2A", "STK11", "SMAD4", "BMPR1A", "MUTYH", "CDH1",
    "PTCH1", "SUFU", "TSC1", "TSC2", "WT1", "MEN1", "RET", "SDHB", "SDHC",
    "SDHD", "MAX", "TMEM127", "FLCN", "FH", "BRAF", "NRAS", "KIT", "PDGFRA",
    "JAK2", "FLT3", "NPM1", "CEBPA", "RUNX1", "ASXL1", "DNMT3A", "TET2",
    "IDH1", "IDH2", "SF3B1", "SRSF2", "U2AF1", "ZRSR2", "BCOR", "STAG2",
    "RAD21", "SMC1A", "SMC3", "CTCF", "ARID1A", "ARID1B", "ARID2", "SMARCA4",
    "SMARCB1", "PBRM1", "SETD2", "BAP1", "CREBBP", "EP300", "KDM6A", "KMT2D",
    "EZH2", "SUZ12", "EED", "FBXW7", "NOTCH1", "NOTCH2", "NOTCH3", "NOTCH4"
}
    ...
    try:
        with gzip.open(vcf_file, 'rt') as f:
            for line in f:
                ...
                consequence = info_dict.get('MC', '').split('|')[1] if 'MC' in info_dict and '|' in info_dict['MC'] else ''
...
def create_database(variants: List[Dict], db_path: str = DB_PATH) -> None:
    ...
    try:
        ...
        for i in range(0, len(variants), batch_size):
            ...
            batch_data = [
                (
                    v['chrom'], v['pos'], v['ref'], v['alt'], v['gene'],
                    v['gnomad_af'], v['clinical_significance'], v['is_pathogenic'],
                    v['consequence'], v['review_status']
                )
                for v in batch
            ]
...
def main():
    ...
    parser.add_argument('--cancer-genes-only', action='store_true', 
